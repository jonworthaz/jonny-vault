...
## Claude Ideas integration (linked mode)

When opened from [Claude Ideas](../claude-ideas/) with
...
(shared local store `claudeideas.ideas.v1`). If the idea's workflow is **locked**,
